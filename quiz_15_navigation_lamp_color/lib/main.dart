...
import 'package:quiz_15_navigation_lamp_color/controller.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void getData() {
    ...
    if (Message.lampStatus == true && Message.lampPink == false) {
      setState(() {
        _lampImage = 'images/lamp_on.png';
      });
    } else if (Message.lampStatus == true && Message.lampPink == true) {
      setState(() {
        _lampImage = 'images/lamp_pink.png';
      });
    } else {
      setState(() {
